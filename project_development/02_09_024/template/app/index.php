  ...
  <div class="d-flex align-items-center justify-content-center ht-100v">
    ...
    <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
        ...
        <div class="tx-white-5 tx-center mg-b-60">Sample log in page</div>

        <?php
        if (isset($_SESSION['login_err'])) {
          echo '<div class="alert alert-danger">';
          echo "<b>" . $_SESSION['login_err'] . " </b>";
          echo "</div>";
        }
        session_destroy();
        ?>
        ...
        <form action="login.php" method="post">
          <div class="form-group">
            <input type="text" class="form-control fc-outline-dark" name="email" placeholder="Enter your user email">
          </div><!-- form-group -->
          <div class="form-group">
